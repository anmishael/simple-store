...
$objCore->setDebug(1);
$lifetime=3600;
$path = $objCore->getSingleton('Config')->adminUrl;
session_set_cookie_params($lifetime,$objCore->getSingleton('Config')->adminUrl,'.'.$objCore->getSingleton('Config')->siteDomain);
session_start();
...
$objCore->getSingleton('Controller/Admin/Default')->actionIndex();
