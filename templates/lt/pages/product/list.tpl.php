...
?>
<?php if($this->_page instanceof Model_Page) { ?>
<h1 class="pagetitle"><?php echo $this->_page->get('name'); ?></h1>
<hr />
<?php } ?>
<div id="product-list">
								...
								<div class="bundle">
									...
									<div class="bundleproducts"><form action="<?php echo $this->topFolder; ?>cart/add" method="get" class="add-to-cart-form">
										...
										<div class="list-buttons right hidden">
											<input<?php echo $disabledall?' disabled="disabled"':''; ?> type="submit" class="button button-small-<?php echo $disabledall?'gray':'light'; ?> submit" value="<?php echo $this->_core->getModel('Translate/Collection')->get('PRODUCT_LIST_ORDER', 'value')->get('value'); ?>" />
