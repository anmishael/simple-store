...
<div id="cart-box">
	...
	<div class="count"><?php echo $this->_cart->size()>0
		?'<a href="' . $this->topFolder . 'cart/list">'.sprintf($this->_core->getModel('Translate/Collection')->get('CART_PRODUCT_COUNT')->get('value'),$this->_cart->size()) . ' <b style="white-space:nowrap;"><span class="price">' . $this->_cart->subtotalsumm() . '</span> <span class="price-label">' . $this->_currency->get('label') . '</span></b></a>'
