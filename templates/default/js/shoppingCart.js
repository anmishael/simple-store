...
//						if(!$('#cart-box .price')[0]) {
						...
						$('#cart-box .count').append($('<b style="white-space:nowrap;"><span class="price">'+$(data).find('cart').attr('total')+'</span> <span class="price-label">'+$(data).find('cart').attr('currency')+'</span></b>'));
//						}
