...
<div id="product-similar-list">
	<h3><?php echo $this->_core->getModel('Translate/Collection')->get('PRODUCT_VIEW_SIMILAR_PRODUCTS')->get('value'); ?></h3>
	<div class="product-list">
		<ul class="products grid">
		<?php $i=0; foreach($this->_items as $item) { ?>
		<?php $images = $item->fetchImages()->get('images'); $image = $images['image'][120]; ?>
