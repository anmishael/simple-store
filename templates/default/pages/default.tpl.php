...
<div id="main-body">
	<div id="menu-header">
		...
		<?php $this->displayBlock('menuheader', true); ?>
		</div></div>
		<div class="clear"></div>
	</div>
				...
				<div class="input">
					<table height="100%" width="98%" cellspacing="0" cellpadding="0" align="right">
						<tr>
							...
							<td width="52" align="right"><input type="image" src="<?php echo $this->templateDir; ?>css/images/pixel-trans.gif" width="52" height="30" /></td>
						</tr>
					</table>
				</div>
